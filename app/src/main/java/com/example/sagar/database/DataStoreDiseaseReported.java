...
public class DataStoreDiseaseReported {
    ...
    public void storeDiseaseInfo(String disease_name, String district,
        ...
        if (delete_table) {
            db.delete("disease_info_reported", null, null);
            db.execSQL("DELETE FROM SQLITE_SEQUENCE WHERE NAME = '" + "disease_info_reported" + "'");
        ...
        if (!notclear) {
            ...
            db.insert("disease_info_reported", null, user_data);
        }
    }
